      ...
      <nav className={'main__nav'}>
        <ul className={'main__nav__btns'}>
          <li className={'nav__title'}>
            <i className="fa-solid fa-book" /> Now Reading
          </li>
          <li className={'nav__title'}>
            <i className="fa-solid fa-earth-africa" /> Browse
          </li>
          <li className={'nav__title'}>
            <i className="fa-solid fa-cart-shopping" /> Buy Books
          </li>
          <li className={'nav__title'}>
            <i className="fa-solid fa-star" /> Favourite Books
          </li>
          <li className={'nav__title'}>
            <i className="fa-solid fa-list" /> Wishlist
          </li>
          <li className={'nav__title'}>
            <i className="fa-regular fa-clock" /> History
          </li>
        </ul>
      </nav>
